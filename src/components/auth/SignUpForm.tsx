              ...
              <div className="space-y-5">
                <div className="grid grid-cols-1 gap-5">
                  <div className="sm:col-span-1">
                    ...
                    <span className="text-sm text-red-500">
                      {formRegister?.formState?.errors?.username?.message}
                    </span>
                  </div>
                </div>
                {/* <!-- Email --> */}
                ...
                <div>
                  <button
                    type="submit"
                    disabled={!isChecked}
                    className={`bg-brand-500 shadow-theme-xs hover:bg-brand-600 flex w-full items-center justify-center rounded-lg px-4 py-3 text-sm font-medium text-white transition disabled:bg-amber-50 disabled:text-[#0a0a0a] disabled:shadow-md`}
                  >
                    Sign Up
                  </button>
                </div>
